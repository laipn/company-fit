...
There are legitimate processes to resolve these scenarios (certainly courts do all the time), but companies themselves do not actual provide transparently their own internal decision-making.  There is no reason to not transparently document the procedure other than the legal (financial) liabilities in doing so. But this conscious lack of transparency in itself is an ethical decision that was made.
